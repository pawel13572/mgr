...
def main(num_epochs=NUM_EPOCHS):
    ...
    l_out = lasagne.layers.DenseLayer(l_forward_2, num_units=vocab_size, W=lasagne.init.Normal(),
    ...
    try:
        for it in xrange(data_size * num_epochs / BATCH_SIZE):
            ...
            for _ in range(PRINT_FREQ):
                ...
                avg_cost += train(x, y)
            print("Epoch {} average loss = {}".format(it * 1.0 * PRINT_FREQ / data_size * BATCH_SIZE,
                                                      avg_cost / PRINT_FREQ))
